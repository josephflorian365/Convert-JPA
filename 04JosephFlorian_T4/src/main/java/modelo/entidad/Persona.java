...
@NamedQueries({
    ...
    @NamedQuery(name = "Persona.findByEnfermedad", query = "SELECT p FROM Persona p WHERE p.enfermedad = :enfermedad"),
    @NamedQuery(name = "Persona.findByDescEnf", query = "SELECT p FROM Persona p WHERE p.descEnf = :descEnf"),
...
public class Persona implements Serializable {
    ...
    public Persona(BigDecimal codigo) {
        this.codigo = codigo;
    }
    ...
    public String toString() {
        return "modelo.entidad.Persona[ codigo=" + codigo + " ]";
    }
